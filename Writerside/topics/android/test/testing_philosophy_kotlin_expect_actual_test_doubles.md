...
JUnit теперь — это платформа **автоматизированной верификации поведения**. Неважно, unit ты проверяешь или взаимодействие нескольких
микросервисов. JUnit — это способ **отформализовать ожидание** и положиться на tooling.
